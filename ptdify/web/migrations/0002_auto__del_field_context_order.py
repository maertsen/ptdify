...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Context.order'
        db.delete_column('web_context', 'order')


    def backwards(self, orm):
        
        # Adding field 'Context.order'
        db.add_column('web_context', 'order', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)
