...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('web_realm', 'name', self.gf('django.db.models.fields.CharField')(default='Personal', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Realm.name'
        db.delete_column('web_realm', 'name')
