...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Action.future'
        db.delete_column('web_action', 'future')

        # Adding field 'Action.status'
        db.add_column('web_action', 'status', self.gf('django.db.models.fields.CharField')(default='N', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Action.future'
        db.add_column('web_action', 'future', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Action.status'
        db.delete_column('web_action', 'status')
